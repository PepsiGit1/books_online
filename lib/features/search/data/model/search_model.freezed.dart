...
class _$SearchModelImpl implements _SearchModel {
  ...
  @override
  String toString() {
    return 'SearchModel(id: $id, title: $title, author: $author, coverImageUrl: $coverImageUrl, rating: $rating, progress: $progress, categoryId: $categoryId, isPremium: $isPremium, isSaved: $isSaved)';
  }
